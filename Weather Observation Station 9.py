...
# MAGIC %md
# MAGIC Query the list of CITY names from STATION that do not start with vowels. Your result cannot contain duplicates.
# MAGIC
# MAGIC Input Format
# MAGIC
...
# MAGIC FROM Station
# MAGIC WHERE LOWER(LEFT(City,1)) not in ('a','e','i','o','u') 
